...
SELECT e1.emp_name, e1.dept_id, e1.dob, e2.emp_name, e2.emp_id, e2.dob, DATEDIFF(DAY, e1.dob, e2.dob) 
FROM employee e1 
LEFT JOIN employee e2 ON e1.manager_id = e2.emp_id
WHERE DATEDIFF(DAY, e1.dob, e2.dob) > 0;

SELECT e1.emp_name, DATEDIFF(DAY, e1.dob, e2.dob) as days_older
FROM employee e1 
